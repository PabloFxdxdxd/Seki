...
Widget itemTareaCompleted({required ActivityData tarea}) {
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(tarea.title,
                style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 17, color: Colores.textPrimary, decoration: TextDecoration.lineThrough)),
