        ...
        title: Row(
          children: [
            CircleAvatar(
              ...
              radius: 20,
              child: Icon(Icons.person_outline, color: Colores.iconNormal),
            ),
            Padding(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Colores
                          .primaryTransparente, // Fondo blanco no seleccionado
            ...
            Expanded(
              child: Container(
                ...
                child: StreamBuilder<List<ActivityData>>(
                  ...
                  stream: globalDatabase.verMisTareasTerminadas(
                    currentUser!.id,
                  ),
          ...
          child: FloatingActionButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => FormActividad(),
                ), //Navega al formulario de actividad sin datos para crear una nueva tarea
              );
            },
