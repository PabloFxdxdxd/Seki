...
class _PantallaLoginState extends State<PantallaLogin> {
  ...
  void entrar() async {
    ...
    final usuario = await globalDatabase.validarCredenciales(
      correoController.text,
      passwordController.text,
    );
    if (!mounted)
      return; //Si se usará Navigator.push en una función asincrona debe ir el if (!mounted) para evitar brechas de seguridad
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(
                  height: 40,
                ), //separa los elementos con un espacio
                //Campo de Correo
                Text(
                  "Correo electrónico",
                  style: TextStyle(color: Colores.background, fontSize: 15),
                ),
